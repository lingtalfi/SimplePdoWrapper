...
MysqlInfoUtil::__construct
================



MysqlInfoUtil::__construct — Builds the MysqlInfoUtil instance.
...
Source Code
===========
See the source code for method [MysqlInfoUtil::__construct](https://github.com/lingtalfi/SimplePdoWrapper/blob/master/Util/MysqlInfoUtil.php#L26-L29)
...
Next method: [setWrapper](https://github.com/lingtalfi/SimplePdoWrapper/blob/master/doc/api/Ling/SimplePdoWrapper/Util/MysqlInfoUtil/setWrapper.md)<br>
